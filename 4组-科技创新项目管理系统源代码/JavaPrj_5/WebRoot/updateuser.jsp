...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >更新账号信息</th>
  </tr>
			...
			<TD width="100%">
				...
				<legend>修改账号信息</legend>
					  ...
					  <tr>
					    ...
					    <td><input name="sex" type="radio" value="1" <%=new Byte("1").equals(u.getSex())?"checked":""%>> 教师
							<input name="sex" type="radio" value="0" <%=new Byte("1").equals(u.getSex())?"":"checked"%>>学生</td>
