<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Class_List.aspx.cs" Inherits="Class_List" %>
    ...
    <div>
        ...
        <table align="center" border="1" bordercolordark="#9cc7ef" bordercolorlight="#145aa0"
                    ...
                    <div align="center">
                       <font color="#ffffff"><span style="color: #000000"><span style="font-size: 12pt;
                            ...
                            mso-bidi-language: AR-SA"><span style="font-size: 10.5pt; font-family: 宋体; mso-hansi-font-family: 'Times New Roman';
                                ...
                                mso-ascii-font-family: 'Times New Roman'"> 班级管理</span></span></span></font></div>
                </td>
            </tr>
            <tr>
                <td width="79%">
                    &nbsp; &nbsp; &nbsp; &nbsp;<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="ID" 
                                DataNavigateUrlFormatString="class.aspx?ID={0}" HeaderText="编辑" Text="编辑" />
                            <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="classD.aspx?ID={0}"
            ...
            <tr>
                <td colspan="1">
                    <div align="center">
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="class.aspx" Target="_self">添加</asp:HyperLink>&nbsp;</div>
                </td>
            </tr>
            <tr bgcolor="#999999">
                <td colspan="1">
