<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GongGao_List.aspx.cs" Inherits="GongGao_List" %>
                    ...
                    <div align="center">
                       <font color="#ffffff"><span style="color: #000000"><span style="font-size: 12pt;
                            ...
                            mso-bidi-language: AR-SA"><span style="font-size: 10.5pt; font-family: 宋体; mso-hansi-font-family: 'Times New Roman';
                                ...
                                mso-ascii-font-family: 'Times New Roman'"> <strong>公告管理</strong></span></span></span></font></div>
                </td>
            </tr>
            <tr>
                <td width="79%">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                              ...
                              <asp:HyperLinkField DataNavigateUrlFields="ID" 
                                DataNavigateUrlFormatString="GongGaoDetial.aspx?ID={0}" HeaderText="标题" 
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="ID" 
                                DataNavigateUrlFormatString="GongGao.aspx?ID={0}" HeaderText="编辑" Text="编辑" >
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:HyperLinkField>
