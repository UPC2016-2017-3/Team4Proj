...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyChengJi_List.aspx.cs" Inherits="MyChengJi_List" %>
                    ...
                    <div align="center">
                       <font color="#ffffff"><span style="color: #000000"><span style="font-size: 12pt;
                            ...
                            mso-bidi-language: AR-SA"><span style="font-size: 10.5pt; font-family: 宋体; mso-hansi-font-family: 'Times New Roman';
                                ...
                                mso-ascii-font-family: 'Times New Roman'"> 成绩管理</span></span></span></font></div>
                </td>
            </tr>
            <tr>
                <td width="79%">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>     <asp:BoundField DataField="XueHao" HeaderText="学号" />
                            <asp:BoundField DataField="SutdentName" HeaderText="姓名" />
                            ...
                            <asp:BoundField DataField="ShiJian" HeaderText="时间" />                            
                              ...
                              <asp:BoundField DataField="ChengJi" HeaderText="成绩" />
