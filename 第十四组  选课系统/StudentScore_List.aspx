<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentScore_List.aspx.cs" Inherits="StudentScore_List" %>
                    ...
                    <div align="center">
                       <font color="#ffffff"><span style="color: #000000"><span style="font-size: 12pt;
                            ...
                            mso-bidi-language: AR-SA"><span style="font-size: 10.5pt; font-family: 宋体; mso-hansi-font-family: 'Times New Roman';
                                ...
                                mso-ascii-font-family: 'Times New Roman'"> 考试成绩管理</span></span></span></font></div>
                </td>
            </tr>
            <tr>
                <td width="79%">
