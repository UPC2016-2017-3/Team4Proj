<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YXKeMu_List.aspx.cs" Inherits="YXKeMu_List" %>
                    ...
                    <div align="center">
                       <font color="#ffffff"><span style="color: #000000"><span style="font-size: 12pt;
                            ...
                            mso-bidi-language: AR-SA"><span style="font-size: 10.5pt; font-family: 宋体; mso-hansi-font-family: 'Times New Roman';
                                ...
                                mso-ascii-font-family: 'Times New Roman'"> 已选课程</span></span></span></font></div>
                </td>
            </tr>
            <tr>
                <td width="79%">
                    &nbsp; &nbsp; &nbsp; &nbsp;<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="ID,KID" DataNavigateUrlFormatString="TX.aspx?ID={0}&KID={1}"
                                HeaderText="退选" Text="退选" />
                        </Columns>
